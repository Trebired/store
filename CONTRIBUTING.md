...
Thanks for helping improve `@trebired/store`.
...
- Keep entity storage generic and host-owned.
- Keep runtime context, modes, and cache behavior explicit.
- Prefer reusable storage primitives over product-specific branches.
- Avoid app routes, UI language, or deployment assumptions.
